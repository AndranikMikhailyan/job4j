...
public class StartUI {
    ...
    /**
     * Метод реализует вывод в консоль всеч заявок.
     */
    protected void findAllItem() {
